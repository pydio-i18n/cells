...
package idm // import "github.com/pydio/cells/proto/idm"
...
import _ "github.com/pydio/cells-new/common/proto/service"
import _ "github.com/pydio/cells-new/common/proto/tree"
...
func (this *Workspace) Validate() error {
	...
	if !(len(this.Slug) < 500) {
		return github_com_mwitkow_go_proto_validators.FieldError("Slug", fmt.Errorf(`value '%v' must length be less than '500'`, this.Slug))
	}
	for _, item := range this.Policies {
		if item != nil {
			if err := github_com_mwitkow_go_proto_validators.CallValidatorIfExists(item); err != nil {
