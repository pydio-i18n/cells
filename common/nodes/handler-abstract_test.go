...
func emptyFakeWrapper() (Client, *HandlerMock) {
...
func errorFakeWrapper() (Client, *HandlerMock) {
...
type methodTester func(Client) error

func testMethod(tester methodTester) (Client, *HandlerMock, error) {
...
func TestWrapper(t *testing.T) {
	...
	Convey("Test wrapper on ReadNode", t, func() {
		...
		_, mock, errTest := testMethod(func(h Client) error {
