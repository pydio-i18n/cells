        ...
        return(
            <div style={{display:'flex', ...style}}>
                {tabs.map(t => {
                    ...
                    return <FlatButton label={label} onClick={()=>{onChange(t.Value)}} primary={isActive} style={isActive?{borderBottom: '2px solid ' + primary1Color}:{borderBottom:0}} labelStyle={{textTransform:'none'}}/>
                })}
                <span style={{flex: 1}}/>
            </div>
        );
