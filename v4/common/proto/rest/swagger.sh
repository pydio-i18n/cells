...
swagger-codegen generate -i $BRANCH_PATH/src/github.com/pydio/cells/v4/common/proto/rest/rest.swagger.json -l javascript -c swagger-jsclient.json -o /tmp/js-client
