...
type BrokerService interface {
	Publish(ctx context.Context, opts ...client.CallOption) (Broker_PublishService, error)
...
func (c *brokerService) Publish(ctx context.Context, opts ...client.CallOption) (Broker_PublishService, error) {
	req := c.c.NewRequest(c.name, "Broker.Publish", &PublishRequest{})
	stream, err := c.c.Stream(ctx, req, opts...)
	if err != nil {
		return nil, err
	}
	return &brokerServicePublish{stream}, nil
}

type Broker_PublishService interface {
...
type brokerServicePublish struct {
	stream client.Stream
}

func (x *brokerServicePublish) CloseAndRecv() (*Empty, error) {
...
func (x *brokerServicePublish) Context() context.Context {
	return x.stream.Context()
}

func (x *brokerServicePublish) SendMsg(m interface{}) error {
	return x.stream.Send(m)
}

func (x *brokerServicePublish) RecvMsg(m interface{}) error {
	return x.stream.Recv(m)
}

func (x *brokerServicePublish) Send(m *PublishRequest) error {
	return x.stream.Send(m)
}
...
func (h *brokerHandler) Publish(ctx context.Context, stream server.Stream) error {
...
func (x *brokerPublishStream) SendAndClose(in *Empty) error {
...
func (x *brokerPublishStream) Context() context.Context {
	return x.stream.Context()
}
