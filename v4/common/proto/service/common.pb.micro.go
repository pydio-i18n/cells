...
type StarterService interface {
	Start(ctx context.Context, in *empty.Empty, opts ...client.CallOption) (*empty.Empty, error)
}
...
func (c *starterService) Start(ctx context.Context, in *empty.Empty, opts ...client.CallOption) (*empty.Empty, error) {
...
func RegisterStarterHandler(s server.Server, hdlr StarterHandler, opts ...server.HandlerOption) error {
	type starter interface {
		Start(ctx context.Context, in *empty.Empty, out *empty.Empty) error
	}
	type Starter struct {
		starter
	}
...
func (h *starterHandler) Start(ctx context.Context, in *empty.Empty, out *empty.Empty) error {
...
type Service interface {
	Status(ctx context.Context, in *empty.Empty, opts ...client.CallOption) (*StatusResponse, error)
}
...
func (c *service) Status(ctx context.Context, in *empty.Empty, opts ...client.CallOption) (*StatusResponse, error) {
...
func RegisterServiceHandler(s server.Server, hdlr ServiceHandler, opts ...server.HandlerOption) error {
	type service interface {
		Status(ctx context.Context, in *empty.Empty, out *StatusResponse) error
	}
	type Service struct {
		service
	}
...
func (h *serviceHandler) Status(ctx context.Context, in *empty.Empty, out *StatusResponse) error {
