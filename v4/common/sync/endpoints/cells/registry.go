...
func (r *RegistryRefreshClient) NewMessage(topic string, msg interface{}, opts ...client.MessageOption) client.Message {
	return r.w.NewMessage(topic, msg, opts...)
}
...
func (r *RegistryRefreshClient) Publish(ctx context.Context, p client.Message, opts ...client.PublishOption) error {
